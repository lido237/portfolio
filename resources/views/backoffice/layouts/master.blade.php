...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="./back/assets/images/favicon.png">
    <title>Adminmart Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="./back/assets/extra-libs/c3/c3.min.css" rel="stylesheet">
    <link href="./back/assets/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="./back/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- Custom CSS -->
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="./back/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="./back/assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="./back/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="./back/assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="./back/assets/images/users/profile-pic.jpg" alt="user" class="rounded-circle"
                                    width="40">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="border-top-0 px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="./back/assets/images/users/widget-table-pic1.jpg"
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="./back/assets/images/users/widget-table-pic2.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="./back/assets/images/users/widget-table-pic3.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="./back/assets/images/users/widget-table-pic4.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
    ...
    <script src="./back/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    ...
    <script src="./back/dist/js/feather.min.js"></script>
    <script src="./back/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="./back/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="./back/dist/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <script src="./back/assets/extra-libs/c3/d3.min.js"></script>
    <script src="./back/assets/extra-libs/c3/c3.min.js"></script>
    <script src="./back/assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="./back/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    <script src="./back/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="./back/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js"></script>
    <script src="./back/dist/js/pages/dashboards/dashboard1.min.js"></script>
</body>
